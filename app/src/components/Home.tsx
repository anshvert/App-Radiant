          ...
          <div className="row text-center">
            <div className="col-md-4">
              <img
                ...
                src="https://github.com/anshvert/Mender/assets/53685410/4f00613b-000e-4609-adb5-41208c62e7ed"
                alt="XD"
              ></img>
              ...
              <ul className="timeline">
                <li>
                  <div className="timeline-image">
                    <img
                      ...
                      src="https://github.com/anshvert/Mender/assets/53685410/d1ac5274-50bb-4e0a-9357-aad2e947c0b0"
                      alt=""
                    />
                  </div>
                ...
                <li className="timeline-inverted">
                  <div className="timeline-image">
                    <img
                      className="img-circle"
                      src="https://github.com/ansh-sde0/App-Radiant/assets/122429570/65bf16b6-d654-4f20-afbf-1caefeb7311a"
                      alt=""
                    />
                  </div>
                  <div className="timeline-panel">
          ...
          <div className="row">
            <div className="col-sm-4">
              <div className="team-member">
                <img
                  src="https://github.com/ansh-sde0/App-Radiant/assets/122429570/d5f27b20-3aeb-4caf-aa02-58d47af5a842"
                  className="img-circle"
                  alt=""
                />
                <h4>Ansh Tyagi</h4>
              ...
              <div className="col-lg-8 col-lg-offset-2">
                <div className="modal-body">
                  ...
                  <p>
                    ...
                    item at{" "}
                    <a href="https://freebiesxpress.com/gallery/treehouse-free-psd-web-template/">
                      FreebiesXpress.com
                    </a>
                    .
                  </p>
              ...
              <div className="col-lg-8 col-lg-offset-2">
                <div className="modal-body">
                  ...
                  <p>
                    You can download the PSD template in this portfolio sample
                    item at{" "}
                    <a href="https://freebiesxpress.com/gallery/golden-free-one-page-web-template/">
                      FreebiesXpress.com
                    </a>
                    .
                  </p>
              ...
              <div className="col-lg-8 col-lg-offset-2">
                <div className="modal-body">
                  ...
                  <p>
                    You can download the PSD template in this portfolio sample
                    item at{" "}
                    <a href="https://freebiesxpress.com/gallery/escape-one-page-psd-web-template/">
                      FreebiesXpress.com
                    </a>
                    .
                  </p>
              ...
              <div className="col-lg-8 col-lg-offset-2">
                <div className="modal-body">
                  ...
                  <p>
                    You can download the PSD template in this portfolio sample
                    item at{" "}
                    <a href="https://freebiesxpress.com/gallery/dreams-free-one-page-web-template/">
                      FreebiesXpress.com
                    </a>
                    .
                  </p>
